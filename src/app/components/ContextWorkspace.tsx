...
export function ContextWorkspace({ collapsed, onToggleCollapse }: Props) {
  if (collapsed) {
    return (
      <div style={{ width: 36, flexShrink: 0, background: "#fff", borderLeft: "1px solid #e5eaf2", display: "flex", flexDirection: "column", alignItems: "center", padding: "12px 0", gap: 10 }}>
        ...
        <button onClick={onToggleCollapse} title="搜索结果" style={{ width: 28, height: 28, borderRadius: 7, border: "none", background: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
