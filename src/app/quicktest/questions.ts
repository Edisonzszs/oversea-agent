...
export const QUESTIONS: Question[] = [
  ...
  { id: "m1", module: 2, stem: "B-3　是否已取得法律尽职调查报告、财务审计报告、第三方资产评估/估值报告(出具机构有执业资质并加盖正式签章)?", type: "single", show: a => a["mode"] === "ma", law: "《境外投资管理办法》(商务部令 2014 年第 3 号)第十四条、第十五条。第三方专业报告须附执业资质证明并加盖正式签章,否则判档不得高于 C。", hint: "客观不适用机制仅放开\"标的公司财务审计报告\"(如标的为新设企业、无历史财务数据,客观上无法出具);\"暂未形成\"不属于客观不适用", opts: [
