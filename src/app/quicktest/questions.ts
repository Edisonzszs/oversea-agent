...
export const IND_OPTS: Opt[] = [
  ...
  { v: "D", label: "D　电力、热力、燃气及水" }, { v: "E", label: "E　建筑业" }, { v: "F", label: "F　批发和零售业" },
...
export const MODULES: ModuleDef[] = [
  ...
  { n: 1, title: "模块一　主体资格自查", lead: "本模块六项对应主管机关审查的六项主体资格子标准,其中自查 1、3、4 属\"不予受理\"前置门槛,务请重点对照。" },
  { n: 2, title: "模块二　投资方式与投资行为自查", lead: "已按模块〇选定的投资方式进入对应分支,共通项全部填写。" },
  { n: 3, title: "模块三　境外标的与项目信息自查", lead: null as any },
  { n: 4, title: "模块四　安全审查与敏感要素自查(前置环节)", lead: "安全审查是受理后的前置环节。本模块为事实采集与预警,不能替代主管机关安全审查。" },
  { n: 5, title: "模块五　行业与国别(信息采集)", lead: "本模块采集行业与国别事实信息并即时输出提示,不判档、不计文件分。" },
];
...
export const QUESTIONS: Question[] = [
  ...
  { id: "p_ind2", module: 0, stem: "拟投资行业类别", type: "select", opts: IND_OPTS, hint: "联动模块五行业要点;审批按行业展开审查(境外设厂选 C 制造业;海外仓选 G 交通运输;咨询服务选 L 租赁和商务服务业)" },
  { id: "p_ctry", module: 0, stem: "最终目的地(拟投资国别/地区)", type: "select", opts: [], hint: "选定 22 个需核准国别(朝鲜、伊拉克、南苏丹等)将触发从严预警与模块三 3.3" }, // opts 运行时从 COUNTRY_OPTIONS 填
  { id: "p_amt", module: 0, stem: "拟投资总额与币种", type: "text", placeholder: "如:5,000 万美元(金额一律折美元填报)" },
  { id: "p_path", module: 0, stem: "投资路径", type: "select", opts: PATH_OPTS, hint: "目的地为港澳台或经港澳台中转的,均参照适用(837 号令第三十二条)" },
  ...
  { id: "t4", module: 3, stem: "3.3-①　上述风险防控能力证明材料(风险评估报告+应急预案+当地合规资源安排)是否已备妥?", type: "single", show: a => isRiskCtry(a["p_ctry"]), law: "该国别属从严核准范围;是否核准由主管机关按从严原则裁量。", opts: [
    { v: "b", label: "已备妥(风险评估报告+应急预案+当地合规资源安排)" }, { v: "c", label: "尚未备妥" },
  ]},

  // ── 模块四 安全审查 ──
  { id: "s1a", module: 4, stem: "4-1a　本次投资或后续运营中,是否存在人员/技术跨境安排(跨境派遣技术人员、提供技术指导、培训,或向境外提供技术图纸、工艺、源代码、数据集等)?", type: "single", law: "837 号令第十三条;第十五条(境外投资安全审查制度);《出口管制法》《两用物项出口管制条例》;《中国禁止出口限制出口技术目录》。", opts: [
